                             ...
                             for(Client client:room.userVc)
                               {
                                ...
                                for(int i=0; i<75;i++)
                                {
                                   ...
                                   client.messageTo(Function.NUMBATCH+"|"
                                       ...
                                       +room.numArr1[i]+"|"
                                       +room.numArr2[i]);
                                      //System.out.println("서버 numArr1 "+(i+1)+"번째수"+room.numArr1[i]);
                                      //System.out.println("서버 numArr2 "+(i+1)+"번째수"+room.numArr2[i]);
                                }     
...
//                    break;
                        ...
                        int cnation=Integer.parseInt(st.nextToken());
                         for(Room room:roomVc)
                         {
                            ...
                            {   
                               ...
                               {
                                  client.messageTo((Function.CHOICENATION+"|"
                                                 +id+"|"+name+"|"+avata+"|"+win+"|"+lose+"|"+cnation+"|"));
                               }
                            }   
                         }
                    }
                    ...
                    {
                    	System.out.println("Server BINGOCHECK 케이스문 작동시작");
                    	int rn=Integer.parseInt(st.nextToken());
                    	String rId=st.nextToken();
                    	int panNumber=Integer.parseInt(st.nextToken());
                    	int bingoCheckNumber=Integer.parseInt(st.nextToken());
                    	System.out.println("방번호:"+rn);
                    	System.out.println("판번호:"+panNumber);
                    	System.out.println("빙고체크번호:"+bingoCheckNumber);
                    	for(Room room:roomVc)
                    	{
                           if(room.roomNum==rn)
                           {   
                           	for(Client client:room.userVc)
                           	{
                           		System.out.println("포이치문 돈다...");
                                 client.messageTo((Function.BINGOCHECK+"|"+rId+"|"
                    ...
                    case Function.ATTFURY:
                    {
                    	...
                    	for(Room room:roomVc)
                        {
                            ...
                            {   
                               for(Client client:room.userVc)
                               {
                                  client.messageTo((Function.ATTFURY+"|"+furyId+"|"));
                               }
                            }   
                        }
                    }
                    ...
                    case Function.BINGOEND:
                    {
                    	...
                    	for(Room room:roomVc)
                        {
                            ...
                            {   
                               for(Client client:room.userVc)
                               {
                                  client.messageTo((Function.BINGOEND+"|"
                                                 +endId+"|"+won+"|"));
                               }
                            }   
                        }
